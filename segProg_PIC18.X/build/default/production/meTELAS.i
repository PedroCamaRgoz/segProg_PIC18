...
void buscar_receita (unsigned char adrs, unsigned char * data );
...
void * me_tela_buscar_tecla( void * arg, void * next)
{
    seq.buscarDado(12,teclado,&cond_inicial);
...
void * me_tela_memoria_escolha_tecla( void * arg, void * next)
{
    ...
    switch( get_tecla() )
    {
        ...
        salvar_dado(12, get_tecla() % 0x30, cond_inicial);
...
void * me_tela_memoria_salvando( void * arg, void * next )
{
    seq.buscarDado(12,12,cond_inicial);
...
void * me_tela_execucao_print (void * arg , void * next )
{
    if( execucao.func != me_exec_principal )
    {
       printExec(4,-1);
       printExec(9, 0);
       printExec(14,1);
   ...
   if( execucao.func == me_exec_principal && btt != 2 )
    {
       IHM.printpos(0,0,"       [    ]       ");
       IHM.printpos(1,0,"                    ");
       printExec(4,-1);
    ...
    if( execucao.func == me_exec_vazio && btt == 0 )
    {
